...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/chess_engines/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/chess_engines/archive/master.zip", tmp)
    file += "master"
